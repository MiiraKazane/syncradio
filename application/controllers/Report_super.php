...
class Report_super extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('report_super_model', 'moo');
    ...
    public function ajax_list() {
        ...
        foreach ($list as $rep) {
            ...
            $row[] = 
            '<a class="btn btn-sm btn-default" data-toggle="tooltip" title="Ver reporte" href="report_bestia/report_all/' . "" . $rep->id . "" . '"><i class="glyphicon glyphicon-eye-open"></i></a>

            <a class="btn btn-sm btn-default" href="javascript:void(0)" data-toggle="tooltip" title="Editar reporte" onclick="edit_report(' . "'" . $rep->id . "'" . ')"><i class="glyphicon glyphicon-pencil"></i></a>';
