<!DOCTYPE html>
<head>
   <title>SyncRadio | Nueva orden</title>
...
<div class="content-wrapper">
   <section class="content-header">
      <h1><i class="fa fa-plus" aria-hidden="true"></i> Nueva orden</h1>
      <ol class="breadcrumb">
         <li><a href="<?= (SITE . 'login'); ?>"><i class="fa fa-dashboard"></i> Inicio</a></li>
         <li><a href="<?= (SITE . 'order'); ?>"><i class="fa fa-file-excel-o"></i> Ordenes</a></i>
         <li class="active">Nueva orden</li>
      </ol>
   </section>
   <br><br>
   <div class="container-fluid">
      <div class=" col-md-10 col-md-offset-1 panel panel-info">
         <div class="panel-body">
            ...
            <?php echo form_open('order/add_order', $attr);?>
            <fieldset>
               <div class="form-group">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-3 col-sm-3">
                        ...
                        <input id="number" name="number" placeholder="Número" class="form-control input-md" type="text">
                     </div>
                     <!-- segunda columna -->
                     <div class="col-md-5 col-sm-5">
                        <label class="control-label" for="contract">Contrato</label>  
                        <input id="contract" name="contract" placeholder="Contrato" class="form-control input-md" type="text">
                     </div>
                     <!-- tercera columna -->
                     <div class="col-md-4 col-sm-4">
                        <label class="control-label" for="customer">Cliente</label>
                        <input id="customer" name="customer" placeholder="Cliente" class="form-control input-md" type="text">
                     </div>
                  </div>
               </div>
               <div class="form-group">
                  <div class="row">
                     ...
                     <div class="col-md-3 col-sm-3">
                        ...
                        <select id="kind" name="kind" class="form-control">
                           ...
                           <option value="CAMBIO DE VERSION">CAMBIO DE VERSION</option>
                     ...
                     <div class="col-md-2 col-sm-2">
                        ...
                        <input id="rack" name="rack" placeholder="Rack" class="form-control input-md" type="text"> 
                     </div>
                     <!-- tercera columna -->
                     <div class="col-md-7 col-sm-7">
                        <label class="control-label" for="version">Versión</label>
                        <input id="version" name="version" placeholder="Versión" class="form-control input-md" type="text">
                     </div>
                  </div>
               </div>
               <div class="form-group">
                  <div class="row">
                     ...
                     <div class="col-md-3 col-sm-3">
                        ...
                        <input id="duration" name="duration" placeholder="Duración" class="form-control input-md" type="text">
                     </div>
                     <!-- segunda columna -->         
                     <div class="col-md-5 col-sm-5">
                        <label class="control-label" for="start">Inicio</label>  
                        <input id="start" name="start" placeholder="Inicio" class="form-control input-md datepicker" type="text">  
                     </div>
                     <!-- tercera columna -->
                     <div class="col-md-4 col-sm-4">
                        <label class="control-label" for="end">Termino</label>
                        <input id="end" name="end" placeholder="Termino" class="form-control input-md datepicker" type="text">
                     </div>
                  </div>
               </div>
               <div class="form-group">
                  <div class="row">
                     ...
                     <div class="col-md-4 col-sm-4">
                        ...
                        <input id="hours" name="hours" placeholder="Horario" class="form-control input-md" type="text">
                     </div>
                  </div>
               </div>
               <div class="form-group">
                  <div class="row">
                     ...
                     <div class="col-md-5 col-sm-5">
                        ...
                        <input id="seller" name="seller" placeholder="Vendedor(a)" class="form-control input-md" type="text">
                     </div>
                     <!-- tercera columna -->
