...
<div class="content-wrapper">
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({ 
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url('report_super/ajax_list') ?>",
                "type": "POST" },
                    "ordering": false,
                    "searching": false,
            "scrollY":        "400px",
    ...
    function edit_report(id) {
        ...
        $.ajax({
            url : "<?= site_url('report_super/ajax_edit/') ?>/" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function see_report(id) {
        ...
        $.ajax({
            url : "<?= site_url('report_super/ajax_see/') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
    ...
    function save() {
        ...
        if(save_method == 'add') {
            url = "<?php echo site_url('report_super/ajax_add') ?>";
        } else {
            url = "<?php echo site_url('report_super/ajax_update') ?>";
        }
        ...
        function delete_report(id)
        {
            ...
            {
                $.ajax({
                    url: "<?php echo site_url('report_super/ajax_delete') ?>/" + id,
                    type: "POST",
                    dataType: "JSON",
                    success: function (data)
                    {
                    ...
                    error: function (jqXHR, textStatus, errorThrown)
                    {
                       toastr["error"]('Error obteniendo reporte');
                    }
                });
                    ...
                    <form action="#" id="form" class="form-horizontal">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <textarea name="descripcion" id="descripcion" placeholder="Ingresa descripcion" class="form-control" type="text" onpaste="return false"></textarea>
