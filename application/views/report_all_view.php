      ...
      <table class="table table-default table-condensed">
         <tr class="text-center">
            <td>
               <p>
               <h3>Folio</h3>
               <span class="text-info"><?= $reporte->folio ?></span></p>
            </td>
            <td class="hidden-xs">
               <p>
               <h3>Prioridad</h3>
               <?= see_tipo_reporte($reporte->priority); ?></p>
            </td>
            <td class="hidden-xs">
               <p>
               <h3>Categoría</h3>
            ...
            <td class="<?= color_status($reporte->status); ?>">
               <h3>Estatus</h3>
               <?= see_status($reporte->status); ?>
            </td>
         </tr>
      </table>
      <script>
